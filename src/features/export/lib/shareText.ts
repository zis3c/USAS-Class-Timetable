...
function buildFullShareText(timetable: TimetableItem[] = [], studentName = '', matricNo = '') {
  ...
  let text = 'ðŸ“‹ *JADUAL KULIAH SAYA*\n';
  text += `ðŸ‘¤ ${studentName || 'Pelajar USAS'}\n`;
  text += `ðŸŽ“ No. Matrik: ${matricNo}\n`;
  ...
  text += 'â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”\n';
  text += 'ðŸ“² Dijana oleh Portal Jadual USAS';
  return text;
}
